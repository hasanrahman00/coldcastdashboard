...
export default function StatsBox() {
  const { jobs, apolloFreeJobs, enricherJobs, companyJobs, enrichUploads } = useApp()

  // Jobs + Running span ALL products: Sales Nav + Apollo Free + Company scrape
  ...
  const totalJobs = jobs.length + apolloFree.length + company.length + linkedin.length + enrichJobs.length
  const running =
