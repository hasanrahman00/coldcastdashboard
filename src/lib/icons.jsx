...
// Brand mark — the Coldcast spiral (7 curved blades). Renders in currentColor,
// so on the lime logo tile the CSS sets it dark (#0a0a0a). Kept identical to
// public/favicon.svg so the tab icon and the in-app logo are the same mark.
...
export const IconChartBar = make(<><line x1="6" y1="20" x2="6" y2="14" /><line x1="12" y1="20" x2="12" y2="9" /><line x1="18" y1="20" x2="18" y2="4" /></>)
